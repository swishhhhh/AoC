...
public class Day04Part1 {
    ...
    public static void main(String... args) throws Exception {
        ...
        int answer = calculateScore(winningBoard, lastNumCalled);

        System.out.printf("Number of Boards: %s, Winning Board: %s, Score = %s%n", boardsNumbers.size(), winningBoard, answer);
