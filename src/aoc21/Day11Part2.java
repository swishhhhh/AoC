...
public class Day11Part2 {
    ...
    public static void main(String... args) throws Exception {
        ...
        long MAX = 1_000;
        for (int i = 1; i <= MAX; i++) {
            if (allFlashed(i, grid)) {
                answer = i;
                break;
            }
        }

        System.out.printf("All flashed on step = %s%n", answer);
    ...
    private static boolean allFlashed(int stepNum, char[][] grid) {
        ...
        //check if all flashed AND reset all flashers to 0
