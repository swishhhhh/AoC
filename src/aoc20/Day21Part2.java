...
public class Day21Part2 {
    public static void main(String... args) throws Exception {
        ...
        String answer = new Day21Part2().execute(lines);
        System.out.printf("Answer = %s%n", answer);

        String expected = "lkv,lfcppl,jhsrjlj,jrhvk,zkls,qjltjd,xslr,rfpbpn";
    ...
    private String execute(List<String> lines) {
        ...
        return selectAndSortBadIngredients(ingredientToAllergenMap);
    }
    ...
    private String selectAndSortBadIngredients(Map<String, String> ingredientToAllergenMap) {
        //return a comma-separated list of ingredients sorted by their allergen
        Map<String, String> allergenToIngredientMap = new TreeMap<>(); //sorted map
        for (Map.Entry<String, String> entry : ingredientToAllergenMap.entrySet()) {
            allergenToIngredientMap.put(entry.getValue(), entry.getKey());
        }

        return String.join(",", allergenToIngredientMap.values());
    }
}
